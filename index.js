...
else(votingAge <= 18) {console.log('task 1a' false)}
...
console.log('task1' , multiply(5,4))
...
console.log('task 1d' dogYears(3))
...
console.log('task 3' , hungryDog(10,2))
...
const determineWinner = () => {  if (userInput === getComputerChoice)
  return 'its a tie!';
  if (userInput === 'rock') {
...
const playGame = () => {
  const userInput = getUserInput('scissors');
